        ...
        <div className="m-3 p-5 mt-0 pt-1">
            <form action="" className="mt-2" onSubmit={(e) => search(e)}>
                ...
                <div className="mb-6 grid md:grid-cols-2 gap-2">
                    <select defaultValue="" required id="searchOptions" name="searchOptions" className="text-lg font-['Cutive_Mono'] shadow shadow-pink-500/50 p-2 border border-pink-500 outline-0 rounded caret-pink-500 bg-zinc-700">
                    ...
                    <input required type="search" placeholder="e.g. France" name="searchQuery" className="text-lg font-['Cutive_Mono'] shadow shadow-pink-500/50 p-2 border border-pink-500 outline-0 rounded caret-pink-500 bg-zinc-700"></input>
                </div>
